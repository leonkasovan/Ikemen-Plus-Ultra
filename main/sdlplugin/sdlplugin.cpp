...
// ---------------------------------------------------------------------------
TUserFunc(bool, RendererInit, Reference rendererName, int32_t h, int32_t w, Reference cap)
{
...
// ---------------------------------------------------------------------------
TUserFunc(void, GetRendererInfo, Reference* outInfo)
{
	char buf[512];
...
// ---------------------------------------------------------------------------
TUserFunc(void, EnablePerfMonitor, bool enable)
{
...
// ---------------------------------------------------------------------------
TUserFunc(int32_t, PollInputBitmask,
	int32_t jn,
...
// ---------------------------------------------------------------------------
TUserFunc(void, SoftFill, uint32_t color, SDL_Rect* prect)
{
	LARGE_INTEGER t0, t1;
